              ...
              <div class="row">
                <div class="col-12">
                  <div class="callout callout-info">
                    ...
                    </h5>This page has been enhanced for printing. Click the print button at the bottom of the invoice to
                    test.
                  </div>
                  ...
                  <div class="invoice p-3 mb-3">
                    ...
                    <div class="row no-print">
                      <div class="col-12">
                        <a href="#!" @click="printme" target="_blank" class="btn btn-default">
